...
_HOROSCOPE_BY_COMBINATION = {
    ...
    (Slot.LEMON, Slot.LEMON, Slot.BAR): (
    ...
    (Slot.LEMON, Slot.GRAPE, Slot.GRAPE): (
    ...
    (Slot.LEMON, Slot.SEVEN, Slot.LEMON): (
        "Deine Freunde machen sich über deine Frisur lustig."
    ),
    (Slot.LEMON, Slot.SEVEN, Slot.BAR): (
    ...
    (Slot.GRAPE, Slot.SEVEN, Slot.SEVEN): (
        "Du vergisst deine Schlüssel und wirst Millionär."
    ),
    (Slot.BAR, Slot.LEMON, Slot.LEMON): (
    ...
    (Slot.BAR, Slot.LEMON, Slot.SEVEN): (
    ...
    (Slot.SEVEN, Slot.LEMON, Slot.LEMON): (
    ...
    (Slot.SEVEN, Slot.GRAPE, Slot.GRAPE): (
    ...
    (Slot.SEVEN, Slot.BAR, Slot.GRAPE): (
    ...
    (Slot.SEVEN, Slot.SEVEN, Slot.LEMON): (
